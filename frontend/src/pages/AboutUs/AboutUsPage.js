                ...
                <section className="about-us">
                    <div className="about-us-hero">
                        <div className="hero-content">
                            <h2>Наша история</h2>
                            <p>
                                Основанная в 2010 году, наша компания начала свой путь как небольшое агентство, помогающее специалистам найти работу за рубежом. Сегодня мы — международная рекрутинговая компания с офисами в пяти странах и командой из более чем 100 профессионалов.
                            </p>
                            <p>
                ...
                <section className="team-section">
                    ...
                    <div className="team-members">
                        <div className="team-member">
                            <img src="path_to_member1_photo.jpg" alt="Анна Иванова" />
                            <h3>Анна Иванова</h3>
                            <p>Генеральный директор с опытом работы более 15 лет в сфере HR.</p>
                        </div>
                        <div className="team-member">
                            <img src="path_to_member2_photo.jpg" alt="Игорь Петров" />
                            <h3>Игорь Петров</h3>
